"""
Decomposition module for SL_GPsim.
...
class ParametricDecomposition(BaseDecomposition):
    ...
    def compute(self):
        ...
        freqs = np.fft.fftfreq(self.n_fft, d=1.0/self.sampling_rate)
        # You can choose to fftshift if you want to center zero. But here we leave it as-is.
        ...
        # 5) Return a FrequencyDomainData object (your own class) containing all parts
        from SL_GPsim.frequency_domain import FrequencyDomainData
        return FrequencyDomainData(
            frequencies=freqs,
            combined_spectrum=total_psd,
